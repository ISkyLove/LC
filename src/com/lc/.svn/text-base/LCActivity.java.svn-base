	...
	protected ServiceConnection mServiceConnection = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName name, IBinder service) {
			...
			mSocketService = (ILCSocketService) (((BinderServicePolice) service)
					.getService());
			mSocketService.addSocketServiceConnectListen(LCActivity.this);
			mSocketService.addReceiveDataListen(LCActivity.this);
			mSocketService.addOnSocketSendDataSuccessListen(LCActivity.this);
